...
#define SW_VER "Cubesat payload MCU 0.06"
#define SW_REL "21 Mar 2026"
...
/////////////////////////////////////////////////////////////////////
// Pico
#define VSYS_ANALOG_PIN 29
#define CORR_FACTOR 0.0096293536971503  // (3.3 / 4095.0) * 3.0 * 3.98  gives me Vsys
...
void loop() { 
  ...
  if (millis() - timer > LOG_INTERVAL) {
    ...
    tempC = analogReadTemp(); // Get internal temperature of pico in Celsius
    Vsys = CORR_FACTOR * analogRead(VSYS_ANALOG_PIN);
    uptimeSeconds = millis() / 1000;
    sprintf(buf, "!m:%d,%d,%lu", (int) (tempC*100), 
                             (int) (Vsys*1000),
                             (int) uptimeSeconds);
